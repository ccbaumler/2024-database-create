...
def check_gz_file(file_path, url, tmppath):
    count = 10
        ...
        while download_tries > 0:
            try:
                ...
                if download_tries == 0:
                    ...
                    return  # Exit the function if download fails after multiple attempts
...
def fetch_genomes(urls, formats, output_dir, remove_files, genomes_only):
    ...
    for row in urls:
        ...
        check_gz_file(fpathout, fpathin, tmpfpathout)
...
def main():
    ...
    fetch_genomes(urls = sketch_info, formats = args.format, output_dir = args.output_dir, remove_files=args.remove_files, genomes_only=args.genomes_only)
